...
const Secret2Scene = () => {
    ...
    return (
        <AbsoluteFill style={{ backgroundColor: '#111' }}>
            ...
            <Sequence from={56}>
                <Sequence>
                    <TextOverlay text="女の先生に" y={LAYOUT.CENTER_Y - 80} size={115} color="white" outlineColor="black" outlineWidth="8px" />
                    <TextOverlay text="叱られると..." y={LAYOUT.CENTER_Y + 80} size={115} color="white" outlineColor="black" outlineWidth="8px" />
                </Sequence>
            </Sequence>
            ...
            <Sequence from={0} durationInFrames={bodyDuration}>
                <div style={{
                    ...
                    <div style={{ opacity: frame >= 131 ? 1 : 0 }}>
                        <div>
                            至るところで<span style={{ color: '#D50000', fontSize: '1.3em', textShadow: '3px 3px 0 white'}}>鎖</span>に<br />つながれている」
                        </div>
                    </div>
                </div>
            </Sequence>
